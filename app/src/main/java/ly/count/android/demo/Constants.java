 ...
 * @author wupuquan
 * @version 1.0
 * @since 2018/3/2 11:06
 */
public final class Constants {

    /**
     * Do not put a trailing "/" at the end of the server URL or it won't work.
     * Starting from the version 16.12.03, the SDK will erase the trailing "/" and write a warning to the log.
     */
